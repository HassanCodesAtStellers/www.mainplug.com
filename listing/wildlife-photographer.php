  ...
  <div id="main-wrapper">
    ...
    <div class="featured-slick">
      <div class="featured-slick-slide">
        <div class="dlf-flew">
          <a href="assets/images/photographer02.jpeg" class="mfp-gallery">
            <img
              src="assets/images/photographer02.jpeg"
        ...
        <div class="dlf-flew">
          <a href="assets/images/photographer03.jpeg" class="mfp-gallery">
            <img
              src="assets/images/photographer03.jpeg"
              class="img-fluid mx-auto"
              alt="" />
          </a>
        </div>
        <div class="dlf-flew">
          <a href="assets/images/photographer04.jpeg" class="mfp-gallery">
            <img
              src="assets/images/photographer04.jpeg"
              class="img-fluid mx-auto"
              alt="" />
          </a>
        </div>
        <div class="dlf-flew">
          <a href="assets/images/photographer05.jpeg" class="mfp-gallery">
            <img
              src="assets/images/photographer05.jpeg"
              class="img-fluid mx-auto"
              alt="" />
          </a>
        </div>
        ...
        <div
          ...
          <div class="Rego-lkp-caption ps-3">
            <div class="Rego-lkp-title">
              <h4 class="text-light mb-0 ft-bold">Wild Life Photographer</h4>
            </div>
                ...
                <div class="jbd-details mb-4">
                  ...
                  <div class="review-form-box form-submit mt-3">
                    <form action="home/listing/review" method="post">
                      ...
                      <div class="row">
                        <input type="hidden" name="listing_id" value="69" />
