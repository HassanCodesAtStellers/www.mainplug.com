  ...
  <div id="main-wrapper">
    ...
    <div class="featured-slick">
      <div class="featured-slick-slide">
        <div class="dlf-flew">
          <a href="assets/images/model02.jpeg" class="mfp-gallery">
            <img
              src="assets/images/model02.jpeg"
        ...
        <div class="dlf-flew">
          <a href="assets/images/model03.jpeg" class="mfp-gallery">
            <img
              src="assets/images/model03.jpeg"
              class="img-fluid mx-auto"
              alt="" />
          </a>
        </div>
        <div class="dlf-flew">
          <a href="assets/images/model04.jpeg" class="mfp-gallery">
            <img
              src="assets/images/model04.jpeg"
              class="img-fluid mx-auto"
              alt="" />
          </a>
        </div>
        <div class="dlf-flew">
          <a href="assets/images/model05.jpeg" class="mfp-gallery">
            <img
              src="assets/images/model05.jpeg"
              class="img-fluid mx-auto"
              alt="" />
          </a>
        </div>
        ...
        <div
          ...
          <div class="Rego-lkp-caption ps-3">
            <div class="Rego-lkp-title">
              <h4 class="text-light mb-0 ft-bold">Promotional Model</h4>
            </div>
