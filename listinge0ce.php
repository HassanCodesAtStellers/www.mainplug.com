                        ...
                        <ul class="no-ul-list filter-list">
                          <li>
                            <input
                              ...
                              value="hyundai"
                              type="checkbox" />
                            <label for="cat0" class="checkbox-custom-label">HYUNDAI</label>
                          </li>
                          <li>
                            <input
                              id="cat1"
                              ...
                              value="apartment"
                              type="checkbox" />
                            <label for="cat1" class="checkbox-custom-label">Apartment</label>
                          </li>
                          <li>
                            <input
                              id="cat2"
                              ...
                              value="real-estate"
                              type="checkbox" />
                            <label for="cat2" class="checkbox-custom-label">Real Estate</label>
                          </li>
                          <li>
                            <input
                              id="cat3"
                              ...
                              value="beauty-makeup"
                              type="checkbox" />
                            <label for="cat3" class="checkbox-custom-label">Beauty &amp; Makeup</label>
                          </li>
                          <li>
                            <input
                              id="cat4"
                              ...
                              value="fitness"
                              type="checkbox" />
                            <label for="cat4" class="checkbox-custom-label">Fitness</label>
                          </li>
                          <li>
                            <input
                              id="cat5"
                              ...
                              value="shopping"
                              type="checkbox" />
                            <label for="cat5" class="checkbox-custom-label">Shopping</label>
                          </li>
                          <li>
                            <input
                              id="cat6"
                              ...
                              value="hotel"
                              type="checkbox" />
                            <label for="cat6" class="checkbox-custom-label">Hotel</label>
                          </li>
                          <li>
                            <input
                              id="cat7"
                              ...
                              value="restaurant"
                              type="checkbox" />
                            <label for="cat7" class="checkbox-custom-label">Restaurant</label>
                          </li>
                        </ul>
                      </div>
                        ...
                        <ul class="no-ul-list filter-list">
                          <li>
                            <input
                              ...
                              value="hotel"
                              type="checkbox" />
                            <label for="type0" class="checkbox-custom-label">Hotel</label>
                          </li>
                          ...
                          <li>
                            <input
                              ...
                              value="restaurant"
                              type="checkbox" />
                            <label for="type1" class="checkbox-custom-label">Restaurant</label>
                          </li>
                          ...
                          <li>
                            <input
                              ...
                              value="beauty"
                              type="checkbox" />
                            <label for="type2" class="checkbox-custom-label">Beauty</label>
                          </li>
                          ...
                          <li>
                            <input
                              ...
                              value="real_estate"
                              type="checkbox" />
                            <label for="type3" class="checkbox-custom-label">Real Estate</label>
                          </li>
                          ...
                          <li>
                            <input
                              ...
                              value="doctor"
                              type="checkbox" />
                            <label for="type4" class="checkbox-custom-label">Doctor</label>
                          </li>
                          ...
                          <li>
                            <input
                              ...
                              value="car"
                              type="checkbox" />
                            <label for="type5" class="checkbox-custom-label">Car</label>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        ...
                        class="d-block text-center m-auto"><img
                          src="assets/images/8327890701684832718.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      ...
                      <div class="Rego-cates">
                        <a href="listing4ebb?category=hyundai">HYUNDAI</a>
                      </div>
                      <h4 class="mb-0 ft-medium medium">
                        <a
                          href="listing/new-pop-singer"
                          class="text-dark fs-md">New Hyundai Creta<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                  ...
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        ...
                        class="d-block text-center m-auto"><img
                          src="assets/images/11555413401684832736.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  ...
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        ...
                        class="d-block text-center m-auto"><img
                          src="assets/images/17155441261684832754.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                ...
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing"
                        class="d-block text-center m-auto"><img
                          src="assets/images/5726581381684832787.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      ...
                      <div class="Rego-cates">
                        <a href="listinge0ce?category=apartment">Apartment</a>
                      </div>
                      <h4 class="mb-0 ft-medium medium">
                        <a href="listing" class="text-dark fs-md">Dr. Farhad R. McIntyre<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
                ...
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing"
                        class="d-block text-center m-auto"><img
                          src="assets/images/7890912451684832813.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      ...
                      <h4 class="mb-0 ft-medium medium">
                        <a href="listing" class="text-dark fs-md">Dr. Roy R. McIntyre<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
                          <i class="fas fa-map-marker-alt"></i>G87P,
                ...
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing"
                        class="d-block text-center m-auto"><img
                          src="assets/images/8807026291685015615.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      ...
                      <h4 class="mb-0 ft-medium medium">
                        <a href="listing" class="text-dark fs-md">Dr. Charles R. McIntyre<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
                          <i class="fas fa-map-marker-alt"></i>G87P,
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <nav>
                    <ul class="pagination">
                      ...
                      <li class="page-item">
                        <a class="page-link" href="listing4658?page=2">2</a>
                      </li>
                      <li class="page-item">
                        <a class="page-link" href="listing9ba9?page=3">3</a>
                      </li>
                      <li class="page-item">
                        <a class="page-link" href="listingfdb0?page=4">4</a>
                      </li>

                      <li class="page-item">
                        <a
                          class="page-link"
                          href="listing4658?page=2"
                          rel="next"
