      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="blg_grid_box">
              <div class="blg_grid_thumb">
                <a href="top-places-in-your-town-and-citye">
                  <img
              ...
              <div class="blg_grid_caption">
                ...
                <div class="blg_title">
                  <h4>
                    <a href="top-places-in-your-town-and-citye">Top places in your town and city</a>
                  </h4>
                </div>
                    ...
                    <div class="foot_list_info">
                      <ul>
                        <li>
                          ...
                          <div class="elsio_tx">161 Views</div>
                        </li>
                        <li>
                          <div class="elsio_ic">
                            <i class="fa fa-clock text-warning"></i>
                          </div>
                          <div class="elsio_tx">02 Jan 2019</div>
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="blg_grid_box">
              <div class="blg_grid_thumb">
                <a href="how-we-can-submit-our-websitee">
                  <img
              ...
              <div class="blg_grid_caption">
                ...
                <div class="blg_title">
                  <h4>
                    <a href="how-we-can-submit-our-websitee">How we can submit our website?</a>
                  </h4>
                </div>
                <div class="blg_desc"></div>
              </div>
                    ...
                    <div class="foot_list_info">
                      <ul>
                        <li>
                          ...
                          <div class="elsio_tx">191 Views</div>
                        </li>
                        <li>
                          <div class="elsio_ic">
                            <i class="fa fa-clock text-warning"></i>
