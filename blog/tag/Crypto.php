      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="blg_grid_box">
              <div class="blg_grid_thumb">
                <a href="can-we-get-refund-our-money-crypto">
                  <img
              ...
              <div class="blg_grid_caption">
                ...
                <div class="blg_title">
                  <h4>
                    <a href="can-we-get-refund-our-money-crypto">Can we get refund our money?</a>
                  </h4>
                </div>
                    ...
                    <div class="foot_list_info">
                      <ul>
                        <li>
                          ...
                          <div class="elsio_tx">102 Views</div>
                        </li>
                        <li>
                          <div class="elsio_ic">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="blg_grid_box">
              <div class="blg_grid_thumb">
                <a href="can-we-get-refund-our-money-1">
                  <img
              ...
              <div class="blg_grid_caption">
                ...
                <div class="blg_title">
                  <h4>
                    <a href="can-we-get-refund-our-money-1">Can we get refund our money?</a>
                  </h4>
                </div>
                <div class="blg_desc"></div>
              </div>
                    ...
                    <div class="foot_list_info">
                      <ul>
                        <li>
                          ...
                          <div class="elsio_tx">178 Views</div>
                        </li>
                        <li>
                          <div class="elsio_ic">
                            <i class="fa fa-clock text-warning"></i>
