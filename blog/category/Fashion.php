...
<body>
  ...
  <div
    ...
    id="preloader"
    style="
        background: url(assets/images/preloader.gif) no-repeat scroll
          center center #fff;
      "></div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="blg_grid_box">
              <div class="blg_grid_thumb">
                <a href="how-we-can-submit-our-website-server">
                  <img
                    src="assets/images/RKa6uali1684830505.jpg"
                    class="img-fluid"
                    alt="" />
                </a>
              </div>
              <div class="blg_grid_caption">
                ...
                <div class="blg_title">
                  <h4>
                    <a href="how-we-can-submit-our-website-server">How we can submit our website?</a>
                  </h4>
                </div>
                <div class="blg_desc"></div>
              </div>
                    ...
                    <div class="foot_list_info">
                      <ul>
                        <li>
                          ...
                          <div class="elsio_tx">171 Views</div>
                        </li>
                        <li>
                          <div class="elsio_ic">
                            <i class="fa fa-clock text-warning"></i>
                          </div>
                          <div class="elsio_tx">15 Mar 2022</div>
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="blg_grid_box">
              <div class="blg_grid_thumb">
                <a href="top-places-in-your-town-korea-and-city">
                  <img
              ...
              <div class="blg_grid_caption">
                ...
                <div class="blg_title">
                  <h4>
                    <a href="top-places-in-your-town-korea-and-city">Top places in your town and city</a>
                  </h4>
                </div>
                <div class="blg_desc"></div>
              </div>
                    ...
                    <div class="foot_list_info">
                      <ul>
                        <li>
                          ...
                          <div class="elsio_tx">199 Views</div>
                        </li>
                        <li>
                          <div class="elsio_ic">
                            <i class="fa fa-clock text-warning"></i>
