              ...
              <div class="author-wrap-caption-ngh">
                <div class="author-wrap-jhyu-ngh">
                  <ul>
                    <li>
                      <div class="list-kjvr">
                        <div class="list-kjvr-icon bg-light-sky text-sky">
                          <i class="fas fa-file"></i>
                        </div>
                        <div class="list-kjvr-ctr">
                          <h6 class="count">19</h6>
                        </div>
                        <div class="list-kjvr-text">Listings</div>
                      </div>
                    </li>
                    <li>
                      <div class="list-kjvr">
                        <div
                          class="list-kjvr-icon bg-light-warning text-warning">
                        ...
                        <div class="list-kjvr-text">Followers</div>
                      </div>
                    </li>
                    <li>
                      <div class="list-kjvr">
                        <div
                          class="list-kjvr-icon bg-light-danger text-danger">
                          <i class="fas fa-heart"></i>
                        </div>
                        <div class="list-kjvr-ctr">
                          <h6 class="count">625</h6>
                        </div>
                        <div class="list-kjvr-text">views</div>
                      </div>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="row g-4">
                    <div class="col-12">
                      <a
                        ...
                        class="adv-btn full-width add-follow"
                        data-user=""
                        data-owner=""
                        data-listing="">Follow Now</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <ul>
                  ...
                  <li>
                    <div class="jhk-list-inf">
                      ...
                      <!-- <div class="jhk-list-inf-caption"><h5>Live Web:</h5><p>https://www.xyz.com/</p></div> -->
                    </div>
                  </li>
                </ul>
              </div>
                ...
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing/sake-cafe-sushi-bar-grill"
                        class="d-block text-center m-auto"><img
                          src="assets/images/9110917001678078715.png"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      <div class="Rego-cates">
                        <a href="listingf001?category=restaurant"></a>
                      </div>
                      <h4 class="mb-0 ft-medium medium">
                        <a
                          href="listing/sake-cafe-sushi-bar-grill"
                          class="text-dark fs-md">Sake Cafe Sushi Bar &amp; Grill<span
                            class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
                          <i class="fas fa-map-marker-alt"></i>N Flores St San
                          Antonio, TX 78212
                        </div>
                        <div class="Rego-call">
              ...
              <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-pos ab-left">
                      <div class="Rego-status open me-2">open</div>
                    </div>
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing/hotel-preet-in-californivva-usa"
                        class="d-block text-center m-auto"><img
                          src="assets/images/4565426031684833378.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      <div class="Rego-cates">
                        <a href="listing5a3e?category=hotel"></a>
                      </div>
                      <h4 class="mb-0 ft-medium medium">
                        <a
                          href="listing/hotel-preet-in-californivva-usa"
                          class="text-dark fs-md">Hotel Preet in California, USA<span
                            class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
              ...
              <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing/prestty-woman-smart-batra"
                        class="d-block text-center m-auto"><img
                          src="assets/images/5315288661684833346.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      <div class="Rego-cates">
                        <a
                          href="listingec9f?category=beauty-makeup"></a>
                      </div>
                      <h4 class="mb-0 ft-medium medium">
                        <a
                          href="listing/prestty-woman-smart-batra"
                          class="text-dark fs-md">Pretty Woman Smart Batra<span
                            class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
                          <i class="fas fa-map-marker-alt"></i>Shiv Narkilla,
                          Brazil
                        </div>
                        <div class="Rego-call">
                          <i class="fas fa-phone-alt"></i>0123456789
              ...
              <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing/pizza-pure-delight-cafe"
                        class="d-block text-center m-auto"><img
                          src="assets/images/10204963501679373327.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      ...
                      <h4 class="mb-0 ft-medium medium">
                        <a
                          href="listing/pizza-pure-delight-cafe"
                          class="text-dark fs-md">Pizza Pure Delight Cafe<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
                          <i class="fas fa-map-marker-alt"></i>Liverpool,
                          London
                        </div>
                        <div class="Rego-call">
                          <i class="fas fa-phone-alt"></i>0123456789
                    ...
                    <div class="Rego-grid-footer py-3 px-3">
                      <div class="Rego-ft-first">
                        <div class="Rego-rating">
                          <div class="Rego-pr-average high">1</div>
                          <div class="Rego-rates">
                            <i class="fas fa-star active"></i>
              ...
              <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing/hiphop-rapper"
                        class="d-block text-center m-auto"><img
                          src="assets/images/5987156611684833255.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      <div class="Rego-cates">
                        <a href="listinge0ce?category=apartment"></a>
                      </div>
                      <h4 class="mb-0 ft-medium medium">
                        <a
                          href="listing/hiphop-rapper"
                ...
                <div class="Rego-grid-wrap">
                  <div class="Rego-grid-upper">
                    ...
                    <div class="Rego-grid-thumb">
                      <a
                        href="listing"
                        class="d-block text-center m-auto"><img
                          src="assets/images/10221431691684833223.jpg"
                          class="img-fluid"
                          alt="" /></a>
                    </div>
                  </div>
                  <div class="Rego-grid-fl-wrap">
                    <div class="Rego-caption px-3 py-2">
                      ...
                      <h4 class="mb-0 ft-medium medium">
                        <a href="listing" class="text-dark fs-md">Dr. Michelle R. McIntyre<span
                            class="verified-badge"><i class="fas fa-check-circle"></i></span></a>
                      </h4>
                      <div class="Rego-middle-caption mt-3">
                        <div class="Rego-location">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                <nav>
                  <ul class="pagination">
                    ...
                    <li class="page-item">
                      <a class="page-link" href="admin4658?page=2">2</a>
                    </li>
                    <li class="page-item">
                      <a class="page-link" href="admin9ba9?page=3">3</a>
                    </li>
                    <li class="page-item">
                      <a class="page-link" href="adminfdb0?page=4">4</a>
                    </li>

                    <li class="page-item">
                      <a
                        class="page-link"
                        href="admin4658?page=2"
                        rel="next"
