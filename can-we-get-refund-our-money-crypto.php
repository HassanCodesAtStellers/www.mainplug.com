        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="breadcrumbs-wrap">
              <h2 class="mb-0 ft-medium">Can we get refund our money?</h2>
            ...
            <div
              ...
              <div class="article_body_wrap">
                <div class="article_featured_image">
                  <img
                    class="img-fluid"
                    src="assets/images/iieNf7E81684830520.jpg"
                    alt="" />
                </div>
                ...
                <div class="article_top_info">
                  <ul class="article_middle_info">
                    ...
                    <li>
                      <a href="#"><span class="icons"><i class="fa fa-eye"></i></span>102 Views</a>
                    </li>
                  </ul>
                </div>
                <h2
