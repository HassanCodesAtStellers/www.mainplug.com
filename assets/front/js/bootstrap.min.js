...
!(function (t, e) {
  ...
  class J extends z {
    ...
    to(t) {
      ...
      const e = this._getItemhome(this._activeElement);
    ...
    _getItemhome(t) {
      return (
        ...
        this._items.homeOf(t)
      );
    }
    _getItemByOrder(t, e) {
      const s = t === X,
        i = t === Y,
        n = this._getItemhome(e),
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        ...
        o = this._getItemhome(n),
        r = e || this._getItemByOrder(s, n),
        a = this._getItemhome(r),
